...
%>
        <form name="orderBook" method=post action="placeOrder.jsp">
...
<%
	...
	cs5530.Order order = new Order((cs5530.User) session.getAttribute("user"));
	
%>
<%=order.placeOrder(isbnAttribute, qtyAttribute)%>
<%
